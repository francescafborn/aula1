<html>
    <head>
    <title>Tabela Cidades e Municipios</title>
    </head>
<body>
    <h1>Tabela Cidades e Municipios</h1>
    <br>
<?php
...
<?php
    foreach($estados as $umIndice => $umContato){
         echo("<tr>");
         echo("<td>");
         echo($umIndice);
         echo("</td>");
...
$municipios = array(
    ...
    <?php
        foreach($municipios as $umIndice){
            echo("<tr>");
            echo("<td>");
            echo($umIndice);
            echo("</td>");
